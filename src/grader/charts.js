...
export const SCORE_TABLE = new Map([
  ...
  [
    ...
    {
      description: `<p>
      Subresource Integrity (SRI) implemented, but external scripts are loaded over HTTP, including protocol-relative URLs via <code>src="//..."</code> that can resolve to HTTP.
      </p>`,
      modifier: -20,
      recommendation: `<p>
  ...
  [
    ...
    {
      description: `<p>
        Subresource Integrity (SRI) not implemented, and external scripts are loaded over HTTP, including protocol-relative URLs via <code>src="//..."</code> that can resolve to HTTP.
        </p>`,
      modifier: -50,
      recommendation: `<p>
